...
function updateTimer() {
  const targetDate = new Date("september 26, 2026 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  const verEjemplo = document.getElementById('verEjemplo');
  const lightbox = document.getElementById('lightbox');
  const closeBtn = document.getElementById('closeLightbox');

  if (verEjemplo && lightbox && closeBtn) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '542645575800'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '542645575800'; // Número para el primer botón
